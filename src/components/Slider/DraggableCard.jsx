    ...
    return (
        <div>
             {isContainerVisible && (
                ...
                <div className='col'>
                    <label className='txt-ft'>Select Time Zone:</label>
                        <div className='row'> <select value={selectedTimeZone} style={{width:'200px',display:'flex',justifyContent:'center'}} onChange={handleTimeZoneChange}>
                            {timeZones.map((zone) => (
                        ...
                        <div style={{marginLeft:'0px'}}><h6>Current Date: <input
                            type="date"
                            value={selectedDate}
